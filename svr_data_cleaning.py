...
# r300 = r300.drop(['VISIT', 'PHN_CENTER', 'r300_age', 'echo', 'HT_ECHO', 'ECHO_haz_who', 'WT_ECHO', 'ECHO_waz_who',
#                   'HC_ECHO', 'ECHO_hcaz_who', 'DONE3D', 'QCVISIT'], axis=1)

r300 = r300.drop(['VISIT', 'PHN_CENTER', 'r300_age', 'HT_ECHO', 'ECHO_haz_who', 'WT_ECHO', 'ECHO_waz_who',
                  'HC_ECHO', 'ECHO_hcaz_who', 'DONE3D', 'QCVISIT'], axis=1)
